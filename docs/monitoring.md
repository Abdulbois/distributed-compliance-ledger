...
* Starting from `v0.40.0` Cosmos SDK provides [telemetry](https://docs.cosmos.network/sdk/v0.47/learn/advanced/telemetr) package as a server-side support for application performance and behavior explorations.
